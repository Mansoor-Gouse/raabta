            ...
            {!isOwnProfile && (
              <div className="flex flex-wrap items-center gap-2 mt-3">
                ...
                <Link
                  ...
                  className="elite-events inline-flex items-center justify-center min-h-[44px] px-5 py-2.5 rounded-[var(--elite-radius)] text-sm font-medium bg-[var(--elite-accent)] text-[var(--elite-on-accent)] hover:bg-[var(--elite-accent-hover)] border border-[var(--elite-accent)] transition-colors duration-[var(--elite-transition)]"
                >
                  Message
                </Link>
              </div>
