export function ProfileViewHeaderSkeleton() {
  return (
    <>
      ...
      <div className="px-4 pb-6 -mt-12 sm:-mt-16">
        ...
        <div className="mt-4 h-4 w-40 rounded bg-[var(--elite-border-light)] animate-pulse" />
        <div className="mt-4 flex flex-wrap gap-2">
          {[1, 2, 3].map((i) => (
            <div key={i} className="h-7 w-20 rounded-full bg-[var(--elite-border-light)] animate-pulse" />
          ))}
        </div>
      </div>
    </>
