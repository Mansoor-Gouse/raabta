  ...
  if (posts.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 px-4 bg-[var(--elite-bg)]">
        ...
        <p className="elite-heading font-semibold text-[var(--elite-text)] text-lg">No saved posts</p>
        <p className="elite-body text-sm text-[var(--elite-text-secondary)] mt-1 text-center">Save posts from the feed to see them here.</p>
      </div>
    );
  }
