...
const HAJJ_TITLE_SUGGESTIONS = [
  "Hajj Group",
  "Hajj Journey",
  "Community Hajj",
  "Family Hajj",
  "Hajj with the Network",
];

const HAJJ_LOCATION_OPTIONS = [
  "Makkah",
  "Madinah",
  "Jeddah",
  "Mina",
...
const HAJJ_VIBES = [
  { value: "A guided Hajj journey with the community.", label: "Community Hajj" },
  { value: "Family Hajj with spiritual support.", label: "Family Hajj" },
  { value: "Group travel and accommodation.", label: "Group travel" },
...
export function CreateHajjWizard() {
    ...
    >
      {step === 1 && (
        <BasicsBlock
          ...
          errors={errors}
          showLocation={true}
          titleSuggestions={HAJJ_TITLE_SUGGESTIONS}
          locationOptions={HAJJ_LOCATION_OPTIONS}
        />
      )}
