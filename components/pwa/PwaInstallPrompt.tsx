    ...
    >
      ...
      >
        <div className="flex gap-3 items-start min-w-0">
          <div
            className="flex h-28 w-28 shrink-0 items-center justify-center rounded-full border border-black/[0.06] bg-white p-8 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.02)]"
            aria-hidden
          >
            <Image
              src="/icon-192.png"
